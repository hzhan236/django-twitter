...
SECRET_KEY = 'boo@$cato@hdx*kdv!)d-k(rkr7_1ic0daxd93%_3%bk$!8s+@'
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-haiming'
...
# 然后安装 python 的 memcached 客户端：use `pip install python-memcached`# DO NOT pip install memcache or django-memcached
CACHES = {
    'default': {
